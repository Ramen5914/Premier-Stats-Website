    ...
    return (
        <div className='dark:bg-slate-900 shadow-lg p-4 rounded-2xl flex flex-col min-w-max space-y-2 ml-2'>
            <div className="flex flex-row justify-between">
                <Image priority src={player.imageLink} alt="" width={playerIconSize} height={playerIconSize} />
                <div className="flex flex-col justify-between items-end">
                    <div className='flex flex-row space-x-2 items-center h-min'>
                        <span className="text-xl">{player.peakRank}</span>
                        <Image className='h-min' priority src={`/images/rank/${player.peakRank}.png`} alt="" width={rankSize} height={rankSize} />
                    </div>
                    <div className='flex flex-row space-x-2 items-center h-min'>
                        <span className="text-xl">{player.currentRank}</span>
                        <Image className='h-min' priority src={`/images/rank/${player.currentRank}.png`} alt="" width={rankSize} height={rankSize} />
                    </div>
                </div>
            </div>
            <div className="flex flex-row items-center space-x-2 justify-between">
                <h1 className="text-3xl flex-row flex items-center mr-10 text-slate-400">
                    {player.name}
                    <span className='ml-2 text-xl font-normal text-white bg-indigo-500 px-2 py-1 rounded-lg'>#{player.tag}</span>
                </h1>
                <Link className="p-2 rounded-md bg-slate-800 hover:bg-slate-700 duration-[350ms]" href={player.link}>
