        ...
        <footer className="text-slate-400 ">
            <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
                <div className="flex justify-center md:order-2 space-x-6">
                    <a className="hover:text-slate-500" href="https://github.com/Ramen5914/Premier-Stats-API">
                    ...
                    <a className="hover:text-slate-500" href="https://www.twitch.tv/ramen5914">
                        <span className="icon-tag">
                            Twitch
                        </span>
                    ...
                    <a className="hover:text-slate-500" href="https://www.youtube.com/@Ramen5914ttv">
                        <span className="icon-tag">
                            YouTube
                        </span>
                    ...
                    <a className="hover:text-slate-500" href="https://discord.com/invite/ww7D7jBYDy">
                        <span className="icon-tag">
                            Discord
                        </span>
