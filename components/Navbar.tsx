            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6">
                <div className="flex h-16 justify-between">
                    ...
                    <div className="flex items-center">
                        <div className="flex-shrink-0 flex-row flex space-x-2">
                            ...
                            {extra && 
                                <Link href={redirect[2]} type="button" className="text-white relative inline-flex items-center gap-x-1.5 rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold shadow-sm">
                                    <svg className="-ml-0.5 w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
                                    Add Match
                                </Link>
                            }
                            {trash &&
                                <Link href={pathname + "/delete"} type="button" className="text-white relative inline-flex items-center gap-x-1.5 rounded-md bg-red-600 px-2 py-2 text-sm font-semibold shadow-sm">
