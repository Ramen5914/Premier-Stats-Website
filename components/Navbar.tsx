        ...
        <div className="flex h-16 justify-between">
          <div className="flex">
            ...
            <div className="hidden md:ml-6 md:flex items-center space-x-4">
              <Link
                className="bg-gray-500 dark:bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium"
                aria-current="page"
                href={"/"}
                prefetch={false}
              >
              ...
              <Link
                className="rounded-md px-3 py-2 text-sm font-medium bg-gray-200 dark:bg-transparent hover:bg-gray-300 hover:text-gray-500 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                href={"/teams"}
              >
                Teams
              </Link>
            ...
            <div className="flex-shrink-0 flex-row flex space-x-2">
              ...
              {trash && (
                <Link
                  ...
                  type="button"
                  className="text-white relative inline-flex items-center gap-x-1.5 rounded-md bg-red-600 px-2 py-2 text-sm font-semibold shadow-sm"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
