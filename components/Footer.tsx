    ...
    <footer>
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center md:order-2 space-x-6">
          <a
            className="hover:text-[#000] dark:hover:text-[#fff] si-animation"
            href="https://github.com/Ramen5914/Premier-Stats-API"
          >
          ...
          <a
            className="hover:text-[#9146FF] si-animation"
            href="https://www.twitch.tv/ramen5914"
          >
          ...
          <a
            className="hover:text-[#5865F2] si-animation"
            href="https://discord.com/invite/ww7D7jBYDy"
          >
          ...
          <a
            className="hover:text-[#f00] si-animation"
            href="https://www.youtube.com/@Ramen5914ttv"
          >
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-xs leading-5">
            © 2023 Omar Rahman. All rights reserved. Not affiliated with Riot
            Games.
          </p>
        </div>
      </div>
