...
export default async function PlayerCard({ player }: { player: Player }) {
    return (
        <div className='dark:bg-slate-900 shadow-lg hover:shadow-2xl p-4 rounded-2xl flex flex-row space-x-4 xl:w-[76rem] ring-2 ring-transparent ring-inset hover:ring-indigo-500 duration-[300ms] hover:translate-x-1 hover:-translate-y-1'>
            <Image className='border-4 rounded-xl border-indigo-500' src={player.imageLink} alt="" width={128} height={128} />
            ...
            <div className='flex flex-col justify-between grow'>
                ...
                <div className='grid grid-cols-4 items-center'>
                    <div className='flex flex-row items-center m-auto'>
                        <Image src={'/images/rank/' + player.peakRank + '.png'} alt='' width={64} height={64} />
                        <span className='text-xl ml-2'>{player.peakRank}</span>
                    </div>
                    <div className='flex flex-row items-center m-auto'>
                        <Image src={'/images/rank/' + player.currentRank + '.png'} alt='' width={64} height={64} />
                        <span className='text-xl ml-2'>{player.currentRank}</span>
                    </div>
                    <div className='flex flex-row items-center m-auto'>
